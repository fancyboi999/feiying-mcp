...
# 导入任务管理器
from task_manager import task_manager, start_task_manager, stop_task_manager
...
def parse_args():
    ...
    parser.add_argument("--path", type=str, help="服务器路径")
...
def main():
    ...
    path = args.path or config.get("server_path")
